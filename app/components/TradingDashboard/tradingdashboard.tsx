  ...
  return (
    <div className="bg-transparent min-h-screen p-4 sm:p-6 lg:p-8 font-sans">
      <div className="max-w-full xl:max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          <div className="bg-gradient-to-b from-[#532301] to-transparent p-4 rounded-t-xl mb-0 flex flex-wrap items-center gap-2 justify-between shadow-[0_10px_20px_rgba(43,18,1,0.5),_inset_0_2px_3px_rgba(255,235,205,0.2),_inset_0_-4px_5px_rgba(0,0,0,0.4)]">
