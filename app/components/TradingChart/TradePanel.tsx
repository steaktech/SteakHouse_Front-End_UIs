...
export const TradePanel: React.FC = () => {
  ...
  return (
    <div className="mt-1 box-shadow-1 bg-[#2d1300] rounded-2xl p-4 border-2 border-amber-600/30 shadow-lg h-full flex flex-col">
      ...
      <div className="relative flex w-full rounded-xl bg-[#07040b] p-1 mb-4 border border-gray-700/50">
        {/* Sliding Background */}
        <div
      ...
      <div className="relative mb-4 flex-grow flex flex-col justify-center">
        <input
          ...
          className="w-full bg-[#07040b] text-white text-3xl p-6 rounded-xl border border-[#321806] focus:outline-none focus:ring-2 focus:ring-[#2a882f] text-left h-[65px]"
          placeholder="0"
        />
      ...
      <button className={`w-full font-bold py-4 rounded-lg text-lg transition-colors duration-300 ${
        activeTab === 'buy'
          ? 'bg-[#2a882f] hover:bg-green-700 text-[#2e1400]' // Changed background and text color
          : 'bg-red-600 hover:bg-red-700 text-[#2e1400]'
      }`}>
        CONFIRM TRADE
      </button>
    </div>
