    ...
    (async () => {
      ...
      widgetRef.current = new window.TradingView.widget({
        ...
        overrides: {
          ...
          'mainSeriesProperties.candleStyle.upColor': '#00D08A',
          'mainSeriesProperties.candleStyle.downColor': '#FF4D4D',
          'mainSeriesProperties.candleStyle.borderUpColor': '#00D08A',
          'mainSeriesProperties.candleStyle.borderDownColor': '#FF4D4D',
          'mainSeriesProperties.candleStyle.wickUpColor': '#00D08A',
          ...
          'mainSeriesProperties.barStyle.upColor': '#00D08A',
          'mainSeriesProperties.barStyle.downColor': '#FF4D4D',
          'mainSeriesProperties.hollowCandleStyle.upColor': '#00D08A',
          'mainSeriesProperties.hollowCandleStyle.downColor': '#FF4D4D',
          'mainSeriesProperties.hollowCandleStyle.borderUpColor': '#00D08A',
          'mainSeriesProperties.hollowCandleStyle.borderDownColor': '#FF4D4D',
          'mainSeriesProperties.hollowCandleStyle.wickUpColor': '#00D08A',
          'mainSeriesProperties.hollowCandleStyle.wickDownColor': '#FF4D4D',
          'mainSeriesProperties.haStyle.upColor': '#00D08A',
          'mainSeriesProperties.haStyle.downColor': '#FF4D4D',
          'mainSeriesProperties.haStyle.borderUpColor': '#00D08A',
          'mainSeriesProperties.haStyle.borderDownColor': '#FF4D4D',
          'mainSeriesProperties.haStyle.wickUpColor': '#00D08A',
          'mainSeriesProperties.haStyle.wickDownColor': '#FF4D4D',
        },
        studies_overrides: {
          'volume.volume.color.0': '#FF4D4D',
          'volume.volume.color.1': '#00D08A',
