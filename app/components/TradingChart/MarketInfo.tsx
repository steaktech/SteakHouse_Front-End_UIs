...
export const MarketInfo: React.FC = () => {
  return (
    // --- CHANGES START HERE ---
    <div className="mt-2 box-shadow-1 bg-gradient-to-b from-[#532301] to-[#863c04] rounded-3xl p-4 text-white shadow-lg relative overflow-hidden h-full flex flex-col 
