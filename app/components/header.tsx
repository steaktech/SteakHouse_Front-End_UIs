      ...
      <div className="relative z-10 flex items-center justify-between h-full px-6 md:px-12 lg:px-16">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden sm:flex items-center space-x-2 ml-4">
            ...
            {/* Twitter/X Icon */}
            <div className="w-10 h-10 bg-amber-800 rounded-full flex items-center justify-center cursor-pointer hover:bg-amber-700 transition-colors">
              <svg className="w-4 h-4 fill-current text-yellow-400" viewBox="0 0 1200 1227">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          <button className="bg-amber-900 hover:bg-amber-800 text-yellow-400 font-medium px-2 py-1 sm:px-4 sm:py-2 rounded-lg border border-yellow-600/30 transition-all duration-300 flex items-center space-x-1 sm:space-x-2 shadow-lg text-sm sm:text-base">
            <span className="text-sm sm:text-lg font-bold">+</span>
            <span className="hidden sm:inline">Create Token</span>
            <span className="sm:hidden">Create</span>
          </button>
          <button className="bg-yellow-600 hover:bg-yellow-500 text-black font-medium px-2 py-1 sm:px-4 sm:py-2 rounded-lg border border-yellow-700/30 transition-all duration-300 shadow-lg text-sm sm:text-base">
