      ...
      <div className="w-full md:w-3/4">
        {!isAdvancedOpen && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <FormInput
              label="tax reciever"
              placeholder="0x000000YOURWALLET..."
              name="taxReceiver"
          ...
          {isAdvancedOpen && (
            <div className="mt-4 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <FormInput
                  label="Starting TAX"
                  name="adv_startingTax"
                  value={formData.adv_startingTax}
                  placeholder="20%"
                  onChange={handleInputChange}
                />
                <FormInput
                  label="Tax Drop Increment"
                  name="adv_taxDropAmount"
                  value={formData.adv_taxDropAmount}
                  placeholder="-1%"
                  onChange={handleInputChange}
                />
                <FormInput
                  label="Every X Seconds"
                  name="adv_taxDropBlocks"
                  value={formData.adv_taxDropBlocks}
                  placeholder="60s"
                  onChange={handleInputChange}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <FormInput
                  label="Tax Reciever"
                  name="adv_taxWallet"
                  value={formData.adv_taxWallet}
                  placeholder="0x38hfn84bv&cruirt85nt..."
                  onChange={handleInputChange}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <FormInput
                  label="Starting MaxWallet"
                  name="adv_startingMaxWallet"
                  value={formData.adv_startingMaxWallet}
                  placeholder="0.5%"
                  onChange={handleInputChange}
                />
                <FormInput
                  label="MaxWallet Increase"
                  name="adv_maxWalletIncreaseAmount"
                  value={formData.adv_maxWalletIncreaseAmount}
                  placeholder="+0.1%"
                  onChange={handleInputChange}
                />
                <FormInput
                  label="Every X Seconds"
                  name="adv_maxWalletBlocks"
                  value={formData.adv_maxWalletBlocks}
                  placeholder="60s"
                  onChange={handleInputChange}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <FormInput
                  label="Starting MaxTX"
                  name="adv_startingMaxTx"
                  value={formData.adv_startingMaxTx}
                  placeholder="0.1%"
                  onChange={handleInputChange}
                />
                <FormInput
                  label="MaxTX increase"
                  name="adv_maxTxIncreaseAmount"
                  value={formData.adv_maxTxIncreaseAmount}
                  placeholder="+0.1%"
                  onChange={handleInputChange}
                />
                <FormInput
                  label="Every X Seconds"
                  name="adv_maxTxBlocks"
                  value={formData.adv_maxTxBlocks}
                  placeholder="60s"
                  onChange={handleInputChange}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <FormInput
                  label="Remove Units After X Seconds"
                  name="adv_removeUnitsAfter"
                  value={formData.adv_removeUnitsAfter}
                  placeholder="60s"
                  onChange={handleInputChange}
                />
              </div>
