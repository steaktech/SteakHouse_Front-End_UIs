      ...
      <header className="relative w-full h-20 md:h-20 lg:h-30">
        ...
        <div className="relative z-10 flex items-center justify-between h-full px-6 md:px-12 lg:px-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            <button
              className="bg-amber-900 hover:bg-amber-800 text-yellow-400 font-medium px-2 py-1 sm:px-4 sm:py-2 rounded-lg border border-yellow-600/30 transition-all duration-300 flex items-center space-x-1 sm:space-x-2 shadow-lg text-sm sm:text-base"
